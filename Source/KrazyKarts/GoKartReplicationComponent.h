...
private:
	...
	float VelocityToDerivative() const { return ClientTimeBetweenLastUpdates * 100.0f; };
	...
	void SetMeshOffsetRoot(USceneComponent* _MeshOffsetRoot) { MeshOffsetRoot = _MeshOffsetRoot; };
};
